"""
Step 4: Why Are We Asking For This Page Automation
...
class Step4WhyAreWeAskingForThis(BaseStep):
    """Step 4: Why are we asking for this page automation"""
    
    def __init__(self, driver, travel_data):
        super().__init__(driver, "Step 4: Why Are We Asking For This")
    ...
    def execute(self):
        """
        Execute Step 4: Handle travel plans based on travel_plans value
        ...
        try:
            ...
            logger.info("✅ Step 4 completed successfully - Travel plans form submitted")
